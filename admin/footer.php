    ...
    <footer class="main-footer">
    	...
    	<div class="copyright">Copyright © <?php echo date('Y'); ?> <a href="http://globalsoftpark.com">Global Soft Park</a>, All rights reserved.</div>
    </footer>
</div>
<!-- End Wrapper -->
    ...
    <div class="global-site-notice noscript">
        <div class="notice-inner">
            <p><strong>JavaScript seems to be disabled in your browser.</strong><br>You must have JavaScript enabled in
                your browser to utilize the functionality of #GLOBAL POS.</p>
        </div>
    </div>
</noscript>
